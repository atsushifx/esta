// src/plugins/logger/IntegrationMockLogger.ts
// @(#) : Integration Mock Logger for Component Testing
//
...
/**
 * Lightweight mock logger optimized for integration testing.
 * Focuses on component interaction testing with simple message capture.
 *
 * Unlike E2eMockLogger, this class is designed for:
 * - Fast execution in integration tests
 * - Simple component interaction verification
 * - Synchronous operations only
 * - Single-threaded test scenarios
 */
export class IntegrationMockLogger {
  ...
  /**
   * Create AgLoggerFunction for integration testing.
  ...
  /**
   * Create AgLoggerMap for integration testing.
